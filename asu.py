...
Bots=[mid,Amid,Bmid,Cmid,"u4473d5864d26d21ed59d0a8ba806ff99"]
...
def bot(op):
    try:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
              ...
              if msg.from_ in admin:
            ...
            elif ("Reina gn " in msg.text):
                if msg.from_ in admin:
                    X = cl.getGroup(msg.to)
                    X.name = msg.text.replace("R gn ","")
                    ki.updateGroup(X)
                else:
                    ki.sendText(msg.to,"It can't be used besides the group.")
            elif ("Wa-one gn " in msg.text):
                if msg.from_ in admin:
                    X = cl.getGroup(msg.to)
                    X.name = msg.text.replace("Wa-one gn ","")
                    kk.updateGroup(X)
                else:
                    kk.sendText(msg.to,"It can't be used besides the group.")
            elif ("Aini gn " in msg.text):
                if msg.from_ in admin:
                    X = cl.getGroup(msg.to)
                    X.name = msg.text.replace("Aini gn ","")
                    kc.updateGroup(X)
                else:
            ...
            elif "Reina kick " in msg.text:
                midd = msg.text.replace("Reina kick ","")
                ki.kickoutFromGroup(msg.to,[midd])
            elif "Wa-one kick " in msg.text:
                midd = msg.text.replace("Wa-one kick ","")
                kk.kickoutFromGroup(msg.to,[midd])
            elif "Aini kick " in msg.text:
                midd = msg.text.replace("Aini kick ","")
                kc.kickoutFromGroup(msg.to,[midd])
            elif "Invite " in msg.text:
                midd = msg.text.replace("Invite ","")
                cl.findAndAddContactsByMid(midd)
                cl.inviteIntoGroup(msg.to,[midd])
            elif "Reina invite " in msg.text:
                midd = msg.text.replace("Reina invite ","")
                ki.findAndAddContactsByMid(midd)
                ki.inviteIntoGroup(msg.to,[midd])
            elif "Wa-one invite " in msg.text:
                midd = msg.text.replace("Wa-one invite ","")
                kk.findAndAddContactsByMid(midd)
                kk.inviteIntoGroup(msg.to,[midd])
            elif "Aini invite " in msg.text:
                midd = msg.text.replace("Aini invite ","")
                ...
                kc.sendMessage(msg)
            elif msg.text in ["Reina"]:
                msg.contentType = 13
                msg.contentMetadata = {'mid': Amid}
                ki.sendMessage(msg)
            elif msg.text in ["Wa-one"]:
                msg.contentType = 13
                msg.contentMetadata = {'mid': Bmid}
                kk.sendMessage(msg)
                ...
                msg.text = None
                cl.sendMessage(msg)
            elif msg.text in ["æ„›ã�®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Reina gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '6'}
                msg.text = None
                ki.sendMessage(msg)
            elif msg.text in ["æ„›ã�®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Wa-one gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '8'}
                msg.text = None
                kk.sendMessage(msg)
            elif msg.text in ["æ„›ã�®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Aini gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '10'}
            ...
            elif msg.text in ["Rn cancel","Bot cancel"]:
                if msg.from_ in admin:
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Reina ourl","Reina link on"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    ki.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Wa-one ourl","Wa-one link on"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["Aini ourl","Aini link on"]:
                if msg.toType == 2:
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Reina curl","Reina link off"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["Wa-one curl","Wa-one link off"]:
                if msg.toType == 2:
                    X = kk.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kk.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        kk.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Aini curl","Aini link off"]:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kc.updateGroup(X)
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
                ...
                cl.sendText(msg.to,mid)
            elif "Wa-one" == msg.text:
                ki.sendText(msg.to,Amid)
            elif "Aini" == msg.text:
                kk.sendText(msg.to,Bmid)
            elif "Fourth" == msg.text:
                kc.sendText(msg.to,Cmid)
            ...
            elif msg.text in ["Reina rename "]:
                string = msg.text.replace("Reina rename ","")
                if len(string.decode('utf-8')) <= 20:
                    profile_B = ki.getProfile()
                    profile_B.displayName = string
                    ki.updateProfile(profile_B)
                    ki.sendText(msg.to,"name " + string + " done")
            elif msg.text in ["Wa-one rename "]:
                string = msg.text.replace("Wa-one rename ","")
                if len(string.decode('utf-8')) <= 20:
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["All Join","All join","Join","Reina"]:
              if msg.from_ in admin:
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:
                                    ...
                                    ki.sendText(msg.to,"Sukses Bos")
                                    kk.sendText(msg.to,"Mamam Tuh")
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
                ...
                cl.sendText(msg.to,"Anak Sundala")
                ki.sendText(msg.to,"Kau Sundala")
                kk.sendText(msg.to,"Sudah mo Sundala")
                kc.sendText(msg.to,"Berkelahi deh sundala")
